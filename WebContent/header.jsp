...
<div class="content">
    ...
    <div class="navigation">
    	...
    	<div class="navigation-wrapper">
            ...
            <div class="navigation-item">
                <a href="#" class="features-icon has-submenu">查询</a>
            ...
            <div class="navigation-item">
                <a href="#" class="portfolio-icon has-submenu">商城</a>
                <em class="dropdown-menu"></em>
                <div class="submenu">
                	<a href="#">美食广场	<em></em></a>
                    <a href="#">购物		<em></em></a>
             ...
             <div class="navigation-item">
                <a href="videos.html" class="videos-icon">旅游资讯</a>
                <em class="inactive-menu"></em>
            </div>
            <div class="navigation-item">
                <a href="#" class="gallery-icon has-submenu">约伴</a>
                <em class="dropdown-menu"></em>
                <div class="submenu">
                	<a href="#">找旅伴     <em></em></a>
                </div>
            ...
            <div class="navigation-item">
                <a href="#" class="contact-icon">社交广场</a>
                <em class="inactive-menu"></em>
                 <div class="submenu">
                	<a href="#">旅游动态    <em></em></a>
                    <a href="#">问答   <em></em></a>
